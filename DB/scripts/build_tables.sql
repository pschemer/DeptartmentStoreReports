...
create table	PURCHASE (
	Cid CHAR(3),
	Iid CHAR(3),
	PurchaseDate	NUMBER(6,0),
	Quantity	INTEGER,
	Ccno	number(20,0),
	PRIMARY KEY	(Cid, Iid, PurchaseDate),
...
insert into	CUSTOMER	values	('C01','Home','Washington');
...
insert into	DEPARTMENT	values	('D01','Personnel');
...
insert into	ITEM	values	('I01','Shirt',52,12,42,'D04');
...
insert into	SUPPLIER	values	('S01','Acme','California');
